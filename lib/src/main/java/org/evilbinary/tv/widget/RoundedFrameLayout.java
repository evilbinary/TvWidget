...
public class RoundedFrameLayout extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundedFrameLayout, defStyle, 0);
        mBottomLeftRadius = a.getDimension(R.styleable.RoundedFrameLayout_bottomLeftRadius, -1);
        mBottomRightRadius = a.getDimension(R.styleable.RoundedFrameLayout_bottomRightRadius, -1);
        mTopLeftRadius = a.getDimension(R.styleable.RoundedFrameLayout_topLeftRadius, -1);
        mTopRightRadius = a.getDimension(R.styleable.RoundedFrameLayout_topRightRadius, -1);
        mRadius = a.getDimension(R.styleable.RoundedFrameLayout_radius, -1);
    ...
    private void addRoundPath(int width, int height) {
        ...
        if (mBottomLeftRadius > 0) {
            ...
            RectF arc = new RectF(0, height - mBottomLeftRadius * 2, mBottomLeftRadius * 2, getHeight());
